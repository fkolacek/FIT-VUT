...
$INTERPRETER $TASK.$EXTENSION --input=$LOCAL_IN_PATH/test08.in --output=$LOCAL_OUT_PATH/test08.out --etc=2 --header='Takto vypada hlavicka vystupniho souboru' 2> $LOCAL_OUT_PATH/test08.err

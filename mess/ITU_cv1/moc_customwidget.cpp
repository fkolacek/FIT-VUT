...
**
** Created: Thu Oct 3 09:58:26 2013
...
static const char qt_meta_stringdata_CustomWidget[] = {
    "CustomWidget\0\0newState(QString)\0"
};
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newState((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData CustomWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CustomWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CustomWidget,
      qt_meta_data_CustomWidget, &staticMetaObjectExtraData }
};
